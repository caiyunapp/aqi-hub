...
def test_hj633_2026_pm_boundaries():
    ...
    # 实时报使用小时值，PM2.5=60 主导时 AQI=100、等级 2（100 仍属良）
...
def test_aqi_with_none_values():
    ...
    # 测试部分污染物超出范围：SO2>800 按 IAQI 200 计，O3_1H 超范围仍为 500
    aqi = AQI(
        pm25=75,  # 114
        pm10=150,  # 112
